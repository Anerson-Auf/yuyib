...
| `yuyib::ui_render` | UI rectangle draw list, image-quad extract, explicit CPU/WGPU rectangular clipping, and alpha-blended WGPU colour pass | [Native UI](../guides/native-ui.md) | No GPU textured UI sampling/nested clip stack/scrolling drag/DPI/window loop — Experimental |
